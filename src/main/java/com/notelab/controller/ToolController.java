...
import com.notelab.dao.ToolDao;
...
public class ToolController {
    ...
    public ResponseEntity<Map<String, Object>> list(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(Map.of("tools", ToolDao.listTools()));
    }
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable long id,
        ...
        if (user == null) return AuthUtil.unauth();
        if (!PermService.isSuperAdmin(user)) return forbidden();
        Map<String, Object> existing = ToolDao.getTool(id);
        if (existing == null) {
